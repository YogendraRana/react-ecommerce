...
const Card = ({ item }: { item: ItemType }) => {
    ...
    return (
        <div className='relative rounded-[0.5rem] overflow-hidden bg-[#f1f2f3] cursor-pointer group' onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
            ...
            <AnimatePresence>
                {isHovered && (
                    <motion.div
                        ...
                        exit="hidden"
                    >
                        <motion.button variants={firstButtonVariants} className="card-button" onClick={() => { 
                        ...
                        <motion.button variants={secondButtonVariants} className="card-button">
                            <i className="fa-solid fa-eye"></i></motion.button>
                        <motion.button variants={thirdButtonVariants} className="card-button">
